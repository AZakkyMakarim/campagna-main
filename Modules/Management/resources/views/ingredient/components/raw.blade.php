            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-4 py-3">
                    <label class="inline-flex items-center cursor-pointer">
                        <input
                            type="checkbox"
                            class="sr-only peer"
                            {{ $raw->is_unlimited_stock ? 'checked' : '' }}
                ...
                <td class="px-4 py-3">
                    <div class="flex items-center justify-center gap-2">
                        <button
                            type="button"
                            data-route="{{ route('management.ingredient.update', $raw) }}"
                            @click="$dispatch('open-edit-raw', {
                                        raw: @js($raw),
...
<div
    x-data="editRawModal()"
    x-show="open"
    @open-edit-raw.window="fill($event.detail)"
    x-transition
    x-cloak
