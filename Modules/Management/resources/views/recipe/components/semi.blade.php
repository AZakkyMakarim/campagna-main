            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-4 py-3">
                    <div class="flex items-center justify-center gap-2">
                        <button
                            type="button"
                            data-route="{{ route('management.recipe.update', $semi) }}"
            ...
            >
                <div class="space-y-4">
                    <div>
                        ...
                        <select name="ingredient_id" class="w-full select2 text-gray-300 appearance-none p-2 pr-10 rounded-lg border border-gray-300 bg-white text-gray-700 text-sm">
