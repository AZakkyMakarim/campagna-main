                ...
                <div class="bg-white border rounded-xl shadow-sm">
                    <div class="grid grid-cols-3 divide-x">
                        ...
                        <div class="flex flex-col items-center justify-center px-4 py-4 text-center">
                            <div class="w-10 h-10 rounded-lg bg-orange-100 text-orange-600 flex items-center justify-center mb-2">
                            ...
                            <p class="text-gray-800 text-xs truncate max-w-[120px]">
                        ...
                        <div class="flex flex-col items-center justify-center px-4 py-4 text-center">
                            <div class="w-10 h-10 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center mb-2">
                                <i class="fa fa-bag-shopping text-sm"></i>
                            </div>
        ...
        function orderCart() {
            return {
                ...
                async processPayment() {
                    ...
                    try {
                        const res = await fetch('{{ route('transaction.list-order.store') }}', {
                            method: 'POST',
                            headers: {
